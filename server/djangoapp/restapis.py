...
def get_dealer_from_cf_by_id(url, dealer_id):
    ...
    if json_result:
        ...
        dealer_obj = CarDealer(address=dealer["doc"]["address"], city=dealer["doc"]["city"], full_name=dealer["doc"]["full_name"],
                               ...
                               st=dealer["doc"]["st"], zip=dealer["doc"]["zip"])
    return dealer_obj
...
def analyze_review_sentiments(dealer_review):
    API_KEY = "C6ndm80Hkpf-BA2aQcqI7N78Ht0hPPlbASfyBtNsZSNc"
    NLU_URL = 'https://api.au-syd.natural-language-understanding.watson.cloud.ibm.com/instances/34d69886-e552-42b2-b09c-64fd33f2d54f'
